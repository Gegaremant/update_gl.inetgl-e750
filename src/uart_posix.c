 ...
 *
 * EN: Provides low-level POSIX UART/serial communication functions for the application.
 * RU: Предоставляет низкоуровневые функции POSIX для работы с UART/последовательным портом.
 *
 ***************************************************************************************************
